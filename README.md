...
- Native save creation, atomic replacement, backup rotation, process relaunch, reload, isolated Dolphin GCI-folder interchange, and real Files import/export now pass. The retail save dialogue, recovery UI, and update persistence remain required.
