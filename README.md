...
- Native save creation, atomic replacement, backup rotation, process relaunch, reload, isolated Dolphin GCI-folder interchange, real Files import/export, and in-place app-update persistence now pass. The retail save dialogue and recovery UI remain required.
