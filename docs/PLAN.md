...
- [x] Add an ARM64 iOS device build and reproducible unsigned IPA with staging/archive/runtime-link audits. An independent fresh GitHub clone reproduces the exact package bytes. Signing/install on physical hardware and final license-notice collection remain.
