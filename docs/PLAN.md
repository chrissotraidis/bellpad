...
4. [ ] Run from trademark/title through town creation, save, process exit, relaunch, and persistence. Current evidence reaches K.K.'s new-game dialogue; dialogue advancement and shutdown are blocked.
5. Record rendering, audio, input, RTC, memory, and sanitizer evidence.
