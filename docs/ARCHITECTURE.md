...
GX command stream and normalizes entries before texture conversion; palettes
...
same intended palette semantics on macOS, iOS, and iPadOS; the current title
corruption means that assumption is now under direct runtime audit.
