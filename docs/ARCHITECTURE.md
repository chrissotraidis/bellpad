...
- Backgrounding pauses presentation/audio and clears transient input; foregrounding resumes through Aurora. Bellpad deliberately does not manufacture an out-of-band Animal Crossing save because the game's save routine has gameplay-visible side effects.
