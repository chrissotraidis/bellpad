...
- Animal Crossing now renders through Aurora GX/Metal, but that first title/menu image has incorrect colors, textures, and scene data. Locating and fixing the GX endianness/format/state mismatch is the immediate convergence blocker.
