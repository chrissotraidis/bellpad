...
| Unsigned IPA reproducibility | Pass — two timestamp-normalized sanitizer-hardening release-candidate packages were byte-identical with SHA-256 `5e6b8d832d46a97ed499214088d601cd23cd4256e493f2d06d31619251b0601e`; the preceding post-notice checkpoint also reproduced from an independent fresh clone |
