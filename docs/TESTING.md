...
| Unsigned IPA reproducibility | Pass — two timestamp-normalized NES-presenter release-candidate packages were byte-identical with SHA-256 `4275c925e1bce87f652044e34b1eb9f147be3afa2d2b9c5fe29f4d52e1fbac55`; the preceding post-notice checkpoint also reproduced from an independent fresh clone |
