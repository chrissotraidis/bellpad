...
| Unsigned IPA reproducibility | Pass — two timestamp-normalized post-lifecycle-fix packages were byte-identical with SHA-256 `f71b02a2890b3695e35673f5070270a2ef04490c8bd6d829092ed5bf5c83d864`; the preceding post-notice checkpoint also reproduced from an independent fresh clone |
